...
/* 字库结构体 */
GUI_XBF_DATA 	XBF_GAITI_18_Data;
GUI_FONT     	FONT_GAITI_18;
...
/* 字库存储路径 */
	...
	static const char FONT_GAITI_18_ADDR[] = 	 "0:/楷体18_2bp.xbf";
...
{
	/* 新宋体18 */
	GUI_XBF_CreateFont(&FONT_GAITI_18,              /* GUI_FONT 字体结构体指针 */
					           &XBF_GAITI_18_Data,          /* GUI_XBF_DATA 结构体指针 */
					           GUI_XBF_TYPE_PROP_EXT,           /* 字体类型 */
					           _cb_FONT_XBF_GetData,            /* 获取字体数据的回调函数 */
					           (void *)&FONT_GAITI_18_ADDR);/* 要传输给回调函数的自定义数据指针，此处传输字库的地址 */
