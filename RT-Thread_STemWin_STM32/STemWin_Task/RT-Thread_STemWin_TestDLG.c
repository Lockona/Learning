...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { SLIDER_CreateIndirect, "Slider", ID_SLIDER_0, 30, 80, 20, 80, 8, 0x0, 0 },
    ...
    case WM_NOTIFY_PARENT:
        ...
        case ID_SLIDER_0: // Notifications sent by 'Slider'
            ...
            case WM_NOTIFICATION_VALUE_CHANGED:
                ...
                catch_time = (10 - SLIDER_GetValue(slider_Item_0))?(10 - SLIDER_GetValue(slider_Item_0)):1;
...
*/
WM_HWIN CreateRT_Thread_STemWin_Test(void);
WM_HWIN CreateRT_Thread_STemWin_Test(void) {
    WM_HWIN hWin;
...
void MainTask(void)
{
    ...
    while (1)
    {
        ...
        if (clicked)
        {
            temp = rand() % 150;
            for (i = 0; i < 10; i++)
                GRAPH_DATA_YT_AddValue(Graphdata, temp);
        }
