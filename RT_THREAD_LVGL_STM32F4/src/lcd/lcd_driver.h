...
//void LCD_ShowChar(uint16_t x, uint16_t y, uint8_t num, uint8_t size, uint8_t mode,uint16_t color);						//显示一个字符
...
//void LCD_Show(uint16_t x, uint16_t y, uint8_t mode, uint8_t *s,uint8_t size,uint16_t COLOR);
